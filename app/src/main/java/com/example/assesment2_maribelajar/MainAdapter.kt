...
import com.example.assesment2_maribelajar.R
import com.example.assesment2_maribelajar.databinding.ListHewanBinding
...
class MainAdapter : RecyclerView.Adapter<MainAdapter.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        fun bind(hewan: Hewan) {
            with(binding) {
                namaTxtHewan.text = hewan.nama
                namaLatinHewan.text = hewan.namaLatin
                Glide.with(imageHewan.context)
